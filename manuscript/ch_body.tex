...
Theese approaches reflect fundamentally different
...
synthesis. That wider context is sketced below to
...
in two dimensions as mentioned: representation and supervision, that shape how SVG
...
All of them relying on DiffVG~\cite{liDifferentiableVectorGraphics2020a} to work.
...
storing geometry as explicit B\'{e}zier coordinates that 
...
This brings different aspects to optimization based approaches. Comparing to 
