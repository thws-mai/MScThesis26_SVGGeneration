...
limited by the scarcity of large-scale SVG datasets.h
...
Chapter~\ref{ch:Background}.The optimization loop across all methods 
...
parameters directly. VectorFusion~\cite{jainVectorFusionTexttoSVGAbstracting2022}
...
Particle-based Score Distillation 
(VPSD, Section~\ref{sec:sds_vsd}), as illustrated in 
Figure~\ref{fig:svgdreamer_vpsd}. It also introduces 
