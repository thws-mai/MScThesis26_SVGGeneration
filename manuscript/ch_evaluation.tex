...
This chapter examines how those 14 models evaluated, which metrics used, where those practices 
...
Inference speed and reproducibility are not preferable 
...
Every metric in Table~\ref{tab:eval_signals} operates on rendered pixels,
