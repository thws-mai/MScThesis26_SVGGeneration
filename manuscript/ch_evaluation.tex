...
in the SVG generation still compute it on substantially 
...
described in Section~\ref{ch:Background}. It is useful for 
...
papers still report it for comparability.
...
performance. That five of the fourteen models report no inference 
time at all (Table~\ref{tab:reproducibility}). But it is itself 
a data point, it suggests that computational cost is not 
treated as a first-class evaluation criterion.
...
The absence of a model shows a finding which reflects that 
