...
building a model that generates SVG. This thesis analyzes SVG generation methods around fourteen open-source models 
...
AI language model Claude (Anthropic) was used during the preparation of this thesis for brainstorming, literature comprehension, 
